...
st_energy_1, f_data_1 = filter_bank(data, 100,300,fs,6,window,hop)
st_energy_2, f_data_2 = filter_bank(data, 300,600,fs,6,window,hop)
st_energy_3, f_data_3 = filter_bank(data, 600,1050,fs,6,window,hop)
st_energy_4, f_data_4 = filter_bank(data, 1050,1725,fs,6,window,hop)
st_energy_5, f_data_5 = filter_bank(data, 1725,2737,fs,6,window,hop)
st_energy_6, f_data_6 = filter_bank(data, 2737,4255,fs,6,window,hop)
st_energy_7, f_data_7 = filter_bank(data, 4255,6000,fs,6,window,hop)
