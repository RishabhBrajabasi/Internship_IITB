...
def peak_elimination(audio, window_dur=50, hop_dur=7, threshold_smooth=100, degree=5, range_of_evaluation=20, r1=3.0, r2=1.4, r3=1.02, r4=0.3):
    ...
    #----------------------------------------------------------------------------------------------------------------------#
        if len(st_energy) < threshold_smooth:
            ...
            st_energy = moving_average(st_energy, degree)  # If the no of frames are above, smooth them
    #----------------------------------------------------------------------------------------------------------------------#
...
results_opt = open('F:\Projects\Active Projects\Project Intern_IITB\Parameter Optimization PE V3\Vowel_opt_Window and Hop Test.csv', 'a')
if os.path.getsize('F:\Projects\Active Projects\Project Intern_IITB\Parameter Optimization PE V3\Vowel_opt_Window and Hop Test.csv') == 0:
...
file_name_template_1 = 'F:\Projects\Active Projects\Project Intern_IITB\Parameter Optimization PE V3\\'
