...
audio_file = 'F:\Projects\Active Projects\Project Intern_IITB\Vowel Evaluation PE V4\Analyze\Vowel_Evaluation_V4_I2\\6.wav'
...
for lines in range(len(peak_valley)):
    value = d1[peak_valley[lines][1]]*0.8
    ...
    for ele in range(peak_valley[lines][1], len(d1), 1):
        if d1[ele] < value:
            flash_2 = ele
            break
    plt.hlines(d1[peak_valley[lines][1]]*0.8, flash_1, flash_2, 'red', linewidth='2.0')
