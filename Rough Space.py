...
window_dur = 30                                                                                         # Duration of window in millisec
hop_dur    = 10                                                                                         # Hop duration in millisec
...
#plt.axis([0,length,0,max(data)+0.1*max(data)])
