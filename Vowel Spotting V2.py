...
########################################################################################################################
audio_file = 'F:\Projects\Active Projects\Project Intern_IITB\Vowel Spotting V2\InputTestFile.wav'
...
########################################################################################################################
text_file_4 = open('F:\Projects\Active Projects\Project Intern_IITB\Vowel Spotting V2\Mark.csv', 'w')
########################################################################################################################
...
for i in range(0, len(mark), 2):
    text_file_4.write(str(mark[i] * 0.0000625) + "\t" + str(mark[i+1]*0.0000625) + "\t" + str(j) + "\n")
    j += 1
########################################################################################################################