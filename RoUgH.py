...
result_name = 'Vowel_Evaluation_V3_I6_M6_NewData.csv'

copyfile('C:\Users\Mahe\PycharmProjects\untitled\IIT-B Internship\\RoUgH.py',
...
only_audio = glob.glob(file_name_template_1 + 'Data 3\*.wav')  # Extract file name of all audio samples
only_text = glob.glob(file_name_template_1 + '\Data 3\*.TextGrid')  # Extract file name of all force aligned TextGrid
results_vowel.write(
