...
#----------------------------------------------------------------------------------------------------------------------#
file_name_template_1 = 'F:\Projects\Active Projects\Project Intern_IITB\Poster Presentation\\'
result_name = 'Vowel_Evaluation_V6_Test_7_PP_2.csv'

copyfile('C:\Users\Mahe\PycharmProjects\Internship_IITB\\Poster presentation.py',
         'F:\Projects\Active Projects\Project Intern_IITB\Poster Presentation\\' + result_name[:-4] + '.txt')
