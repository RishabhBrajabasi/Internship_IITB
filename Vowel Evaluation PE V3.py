...
def peak_elimination(audio, window_dur=50, hop_dur=7, degree=5, threshold_smooth=100):
    ...
    try:
        ...
        data = butter_bandpass_filter(data, 300, 2500, fs, order=6)
...
result_name = 'Vowel_Evaluation_V3_I6_M4_Confirm.csv'

copyfile('C:\Users\Mahe\PycharmProjects\untitled\IIT-B Internship\\Vowel Evaluation PE V3.py',
...
for j in only_audio:
    filename1, count1 = peak_elimination(j, window_dur=50, hop_dur=7,degree=7, threshold_smooth=100)  # Run Peak elimination algorithm
