...
file_name_template_1 = 'F:\Projects\Active Projects\Project Intern_IITB\Vowel Evaluation PE V3\\'
result_name = 'Vowel_Evaluation_V3_I6_M5.csv'

copyfile('C:\Users\Mahe\PycharmProjects\untitled\IIT-B Internship\\test2.py',
         'F:\Projects\Active Projects\Project Intern_IITB\Vowel Evaluation PE V3\\' + result_name[:-4] + '.txt')
