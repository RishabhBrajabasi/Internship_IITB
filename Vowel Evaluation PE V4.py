...
result_name = 'Vowel_Evaluation_V4_I15_Norm_MovingAverage_test5.csv'

copyfile('C:\Users\Mahe\PycharmProjects\untitled\IIT-B Internship\\Vowel Evaluation PE V4.py',
         'F:\Projects\Active Projects\Project Intern_IITB\Vowel Evaluation PE V4\\' + result_name[:-4] + '.txt')
