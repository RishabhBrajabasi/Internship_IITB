        ...
        for k in range(len(ripple_value)):
            if k != len(ripple_value) - 1:
                if ripple_upper_limit >= ripple_value[k] >= ripple_lower_limit:
                    ...
                    count_of_vowels += 1
                if ripple_peak[ripple_value.index(ripple_value[k + 1])] - ripple_peak[ripple_value.index(ripple_value[k])] < pr:
...
results_opt = open('F:\Projects\Active Projects\Project Intern_IITB\Parameter Optimization PE V1\Vowel_opt_3.csv', 'a')
if os.path.getsize('F:\Projects\Active Projects\Project Intern_IITB\Parameter Optimization PE V1\Vowel_opt_3.csv') == 0:
...
file_name_template_1 = 'F:\Projects\Active Projects\Project Intern_IITB\Parameter Optimization PE V1\\'
