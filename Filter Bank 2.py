...
st_energy_1, f_data_1 = filter_bank(data, 100,1000,fs,6,window,hop)
st_energy_2, f_data_2 = filter_bank(data, 1000,2000,fs,6,window,hop)
st_energy_3, f_data_3 = filter_bank(data, 2000,3000,fs,6,window,hop)
st_energy_4, f_data_4 = filter_bank(data, 3000,4000,fs,6,window,hop)
st_energy_5, f_data_5 = filter_bank(data, 4000,5000,fs,6,window,hop)
st_energy_6, f_data_6 = filter_bank(data, 5000,6000,fs,6,window,hop)
st_energy_7, f_data_7 = filter_bank(data, 6000,7000,fs,6,window,hop)
...
plt.subplot(212)
plt.plot(st_energy_1,'red',label='[100-1000]')
plt.plot(st_energy_2,'orange',label='[1000-2000]')
plt.plot(st_energy_3,'yellow',label='[2000-3000]')
plt.plot(st_energy_4,'green',label='[3000-4000]')
plt.plot(st_energy_5,'blue',label='[4000-5000]')
plt.plot(st_energy_6,'indigo',label='[5000-6000]',ls='dotted')
plt.plot(st_energy_7,'violet',label='[6000-7000]',ls='dashed')
